...
本文件记录课程论文项目使用的本地材料、网页、数据库、文献和检索线索。后续新增任何来源时，都要追加记录。

## 本地课程材料

| 来源 | 类型 | 获取/读取日期 | 用途 | 备注 |
| --- | --- | --- | --- | --- |
| `文献检索与论文写作课程论文任务书(1).docx` | 课程任务书 | 2026-06-05 | 确认课程目的、选题要求、内容要求、提交要求和评分标准 | 原始材料，不建议直接修改 |
| `文献检索与论文写作结课论文模板-(1).doc` | 论文模板 | 2026-06-05 | 确认封面、目录、摘要、正文、结论、参考文献等格式结构 | 原始材料，不建议直接修改 |
| `基因检测与解读-结课论文任务书-25医检专升本.docx` | 课程任务书 | 2026-06-07 | 确认《基因检测与解读》课程论文目的、选题列表、81号基因、内容要求、提交要求和评分标准 | 81号对应 MSH3；原始材料不直接修改 |
...
| 来源 | 链接 | 访问日期 | 用途 | 备注 |
| --- | --- | --- | --- | --- |
| KDIGO 2024 CKD Evaluation and Management guideline page | https://kdigo.org/guidelines/ckd-evaluation-and-management/ | 2026-06-06 | 确认 CKD 评估与管理指南、分类和风险评估框架 | 官方指南页面 |
| KDIGO 2024 CKD Guideline Executive Summary | https://kdigo.org/wp-content/uploads/2017/02/KDIGO-2024-CKD-Guideline-Executive-Summary.pdf | 2026-06-06 | 支撑 CKD 分期、风险评估、指南背景 | 可作为高权威指南来源 |
| Grams et al., JAMA 2023, eGFR and albuminuria meta-analysis | https://jamanetwork.com/article.aspx?doi=10.1001/jama.2023.17002 | 2026-06-06 | 支撑 eGFR 与尿白蛋白对不良结局风险评估的重要性 | 个人参与者数据荟萃分析 |
| Inker et al., NEJM 2021, creatinine and cystatin C eGFR equations | https://www.nejm.org/doi/full/10.1056/NEJMoa2102953 | 2026-06-06 | 支撑肌酐、胱抑素C及联合 eGFR 方程的研究基础 | 高水平原始研究 |
| PubMed PMID 37787795 | https://pubmed.ncbi.nlm.nih.gov/37787795/ | 2026-06-06 | 对应 JAMA 2023 论文的医学数据库索引 | PubMed 页面可能需要浏览器校验 |
| PubMed PMID 34554658 | https://pubmed.ncbi.nlm.nih.gov/34554658/ | 2026-06-06 | 对应 NEJM 2021 论文的医学数据库索引 | PubMed 页面可能需要浏览器校验 |

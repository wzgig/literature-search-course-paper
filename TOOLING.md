...
| `基因检测与解读_MSH3结课论文/scripts/build_msh3_course_paper_docx.py` | 从 `基因检测与解读_MSH3结课论文/MSH3_COURSE_PAPER_DRAFT.md` 生成 `基因检测与解读_MSH3结课论文/MSH3_COURSE_PAPER_FORMATTED.docx` | 使用同一课程 Word 模板样式，适配《基因检测与解读》MSH3 论文，生成封面、目录、正文、表格、临床路径图、页眉页码、参考文献和查重报告附页 |
